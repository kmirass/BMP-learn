...
return {
	...
	misc = {
		...
		dictionary = {
			...
			k_enemy_score = "Score adverse actuel",
			...
			k_warning_unlock_profile = "Le profil actuel n'est pas totalement débloqué. Si cette partie est classée/un tournoi, veuillez créer un nouveau profil et cliquer sur 'tout débloquer' dans les paramètres du profil.",
